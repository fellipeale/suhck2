...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Gerenciar Médicos</h1>
	</div>

</div>
<div class="row">
	<div class="col-lg-12">
		<sf:form role="form" modelAttribute="medico" method="post" action="gerenciar">
			<div class="col-md-12">
			...
			<div class="col-lg-4">
				<div class="form-group">
					...
					<sf:select path="especialidade" class="form-control">
						<sf:option label="-- Selecione --" value=""></sf:option>
						<sf:options items="${especialidades}" itemLabel="descricao" itemValue="id" />
					</sf:select>
				</div>
			</div>
			<div class="col-lg-3">
				<div class="form-group">
					<label>CRM</label>
					<sf:input id="crm" path="crm" class="form-control" />
				</div>
			</div>
			<div class="col-lg-4">
				<div class="form-group">
